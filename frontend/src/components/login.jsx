    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-cyan-50 flex flex-col lg:flex-row">
      ...
      <div className="lg:w-1/2 flex flex-col justify-center items-center p-8 lg:p-16 bg-gradient-to-br from-cyan-600 to-blue-700 text-white">
        <div className="max-w-lg">
          ...
          <h2 className="text-4xl font-bold mb-6">Welcome to your healthcare dashboard</h2>
          <p className="text-cyan-100 text-lg mb-10">
            Access your medical records, view test results, and manage patient care all in one secure platform.
          </p>
          ...
          <div className="space-y-6">
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-cyan-100 text-sm">Advanced encryption and security protocols to protect patient data</p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-cyan-100 text-sm">All patient information and test results available in one place</p>
              </div>
            </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8">
            ...
            <form onSubmit={handleSubmit}>
              <div className="space-y-6">
                ...
                <div>
                  <label htmlFor="password" className="block text-sm font-medium text-slate-700 mb-2 flex justify-between">
                    <span>Password</span>
            ...
            <div className="mt-8 text-center">
              <p className="text-sm text-slate-600">
                ...
                <a href="/Signup" className="font-medium text-cyan-600 hover:text-cyan-700">
                  Request access
                </a>
              </p>
            </div>
